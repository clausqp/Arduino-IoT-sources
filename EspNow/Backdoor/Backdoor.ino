...
void setup()
{
    ...
    Serial.begin(115200);
    delay(200);
    Serial.println( "Bagdør_v1_01");

    //Serial.print( "doorClosedPin = " ); Serial.println( doorClosedPin );
    //Serial.print( "doorLockedPin = " ); Serial.println( doorLockedPin );
